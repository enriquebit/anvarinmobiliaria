...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- Formulario -->
        <form action="<?= site_url('/admin/empresas/update/' . $empresa->id) ?>" method="POST" id="form-empresa">
            <?= csrf_field() ?>
                    ...
                    <div class="card card-warning">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <span class="badge badge-info">ID: <?= $empresa->id ?></span>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control <?= isset($errors['domicilio']) ? 'is-invalid' : '' ?>" 
                                          ...
                                          name="domicilio" 
                                          rows="3"
                                          placeholder="Dirección completa del domicilio fiscal"><?= old('domicilio') ?? $empresa->domicilio ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($empresa->telefono): ?>
                                            <small class="form-text text-muted">
                                                Formateado: <?= $empresa->telefono_formateado ?>
                                            </small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" 
                                               value="<?= $empresa->created_at ? $empresa->created_at->format('d/m/Y H:i') : 'No disponible' ?>" 
                                               readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" 
                                               value="<?= $empresa->updated_at ? $empresa->updated_at->format('d/m/Y H:i') : 'No disponible' ?>" 
                                               readonly>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    // =====================================================================
    // VALIDACIÓN DEL FORMULARIO - SIMPLE
    // =====================================================================
    ...
    $('#form-empresa').validate({
        ...
        messages: {
            ...
            // telefono: mensajes removidos por simplicidad
            email: {
...
/* Campos readonly con estilo especial */
input[readonly] {
    background-color: #f8f9fa;
    opacity: 1;
}
