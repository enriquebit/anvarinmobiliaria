        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="modalSimulacionLabel">
                    ...
                    Simulación de Tabla de Amortización - <span id="modalLoteClave">Lote</span>
                </h5>
            ...
            <div class="modal-body" style="padding: 15px;">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <div class="card text-white" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="imprimirSimulacion()">
