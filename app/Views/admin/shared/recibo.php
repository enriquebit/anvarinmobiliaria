    ...
    <div class="recibo-container">
        ...
        <div class="recibo-half">
            ...
            <div class="recibo-header">
                ...
                <div class="recibo-info">
                    <div class="folio">RECIBO <?= esc($folio) ?></div>
                ...
                <div class="datos-transaccion">
                    <?php if ($tipo === 'VENTA'): ?>
                        ...
                        <div class="campo">
                            ...
                            <span><?= esc($venta->folio_venta) ?></span>
                        </div>
                        <div class="campo">
                            <label>Lote:</label>
                        ...
                        <div class="campo">
                            ...
                            <span><?= formatear_fecha_espanol($venta->fecha_venta) ?></span>
                        </div>
                        <div class="campo">
                            <label>Tipo:</label>
                            <span><?= ucfirst($venta->tipo_venta ?? 'N/A') ?></span>
                        </div>
                    <?php else: ?>
                        ...
                        <div class="campo">
                            ...
                            <span><?= isset($apartado->fecha_apartado) ? formatear_fecha_espanol($apartado->fecha_apartado) : 'N/A' ?></span>
                        </div>
                        <?php if (isset($apartado->fecha_limite_enganche)): ?>
                        <div class="campo">
            ...
            <?php if ($tipo === 'APARTADO' && isset($apartado)): ?>
            <div class="observaciones">
                <strong>IMPORTANTE:</strong>
                <p>• Este apartado tiene vigencia hasta el <?= formatear_fecha_espanol($apartado->fecha_limite_enganche ?? date('Y-m-d')) ?></p>
                <p>• Para conservar el lote debe liquidar el enganche</p>
                <p>• Conserve este recibo como comprobante de pago</p>
            </div>
            <?php else: ?>
            <div class="observaciones">
                <strong>RECIBO DE VENTA:</strong>
                <p>• Comprobante de pago por venta de lote</p>
        ...
        <div class="recibo-half">
            ...
            <div class="observaciones">
                ...
                <?php if ($tipo === 'VENTA'): ?>
                    <p>• Venta registrada: <?= formatear_fecha_espanol($venta->fecha_venta) ?></p>
                    <p>• Tipo de venta: <?= ucfirst($venta->tipo_venta ?? 'N/A') ?></p>
                    <p>• Precio total: <?= formatPrecio($lote->precio_total ?? 0) ?></p>
                    <p>• Configuración: <?= esc($configuracion->nombre ?? 'N/A') ?></p>
                <?php else: ?>
                    <p>• Enganche requerido: <?= formatear_moneda_mexicana($apartado->monto_enganche_requerido ?? 0) ?></p>
                    <p>• Plazo liquidación: <?= formatear_fecha_espanol($apartado->fecha_limite_enganche ?? date('Y-m-d')) ?></p>
                    <p>• Configuración: <?= esc($configuracion->nombre ?? 'N/A') ?></p>
