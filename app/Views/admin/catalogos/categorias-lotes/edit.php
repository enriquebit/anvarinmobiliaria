...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <form id="formCategoria" action="<?= site_url('/admin/catalogos/categorias-lotes/update/' . $categoria->id) ?>" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion" 
                                  rows="3" placeholder="Descripción opcional de la categoría"><?= old('descripcion', $categoria->descripcion) ?></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            El estado de la categoría se puede cambiar desde la vista principal.
                        </small>
                    </div>
                </div>
