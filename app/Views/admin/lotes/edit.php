...
<li class="breadcrumb-item active"><?= isset($lote) ? 'Editar' : 'Crear' ?></li>
<?= $this->endSection() ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-<?= isset($lote) ? 'edit' : 'plus' ?>"></i> 
                                <?= isset($lote) ? 'Editar Lote' : 'Nuevo Lote' ?>
                            </h3>
                                        ...
                                        <div class="card card-primary">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="numero" name="numero" 
                                                                   value="<?= isset($lote) ? $lote->numero : '' ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?= form_dropdown('empresas_id', $empresas, isset($lote) ? $lote->empresas_id : '', [
                                                        'class' => 'form-control',
                                                        'id' => 'empresas_id',
                                                        'required' => true
                                                    ]) ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?= form_dropdown('proyectos_id', $proyectos, isset($lote) ? $lote->proyectos_id : '', [
                                                        'class' => 'form-control',
                                                        'id' => 'proyectos_id',
                                                        'required' => true,
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?= form_dropdown('divisiones_id', $divisiones, isset($lote) ? $lote->divisiones_id : '', [
                                                        'class' => 'form-control',
                                                        'id' => 'divisiones_id',
                                                        'required' => true,
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?= form_dropdown('manzanas_id', $manzanas, isset($lote) ? $lote->manzanas_id : '', [
                                                        'class' => 'form-control',
                                                        'id' => 'manzanas_id',
                                                        'required' => true,
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <?= form_dropdown('categorias_lotes_id', $categorias, isset($lote) ? $lote->categorias_lotes_id : '', [
                                                                'class' => 'form-control',
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <?= form_dropdown('tipos_lotes_id', $tipos, isset($lote) ? $lote->tipos_lotes_id : '', [
                                                                'class' => 'form-control',
                                                                'id' => 'tipos_lotes_id',
                                                                'required' => true
                                                            ]) ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?= form_dropdown('estados_lotes_id', $estados, isset($lote) ? $lote->estados_lotes_id : '1', [
                                                        'class' => 'form-control',
                                                        'id' => 'estados_lotes_id',
                                                        'required' => true
                                                    ]) ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3" 
                                                              placeholder="Descripción del lote..."><?= isset($lote) ? $lote->descripcion : '' ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" id="construccion" name="construccion" 
                                                                   step="0.01" min="0"
                                                                   value="<?= isset($lote) ? $lote->construccion : '' ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" id="lateral_izquierdo" name="lateral_izquierdo" 
                                                                   step="0.01" min="0"
                                                                   value="<?= isset($lote) ? $lote->lateral_izquierdo : '' ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" id="lateral_derecho" name="lateral_derecho" 
                                                                   step="0.01" min="0"
                                                                   value="<?= isset($lote) ? $lote->lateral_derecho : '' ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" class="form-control" id="precio_m2" name="precio_m2" 
                                                                       step="0.01" min="0" required
                                                                       value="<?= isset($lote) ? $lote->precio_m2 : '' ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" id="precio_total" readonly
                                                                       value="<?= isset($lote) ? number_format($lote->precio_total, 2) : '0.00' ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="color" class="form-control" id="color" name="color" 
                                                           value="<?= isset($lote) ? $lote->color : '#3498db' ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="coordenadas_poligono" name="coordenadas_poligono" rows="3"
                                                              placeholder="Coordenadas del polígono para mapas (opcional)..."><?= isset($lote) ? $lote->coordenadas_poligono : '' ?></textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="longitud" name="longitud" 
                                                                   ...
                                                                   value="<?= isset($lote) ? $lote->longitud : '' ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="icheck-primary">
                                                                    <input type="checkbox" id="amenidad_<?= $id ?>" name="amenidades[]" value="<?= $id ?>"
                                                                           <?= in_array($id, $amenidades_seleccionadas) ? 'checked' : '' ?>>
...
$(document).ready(function() {
    ...
    function generarClave() {
        const empresa = $('#empresas_id option:selected').text();
        const proyecto = $('#proyectos_id option:selected').text();
        const manzana = $('#manzanas_id option:selected').text();
        const numero = $('#numero').val();

        if (proyecto !== 'Seleccionar proyecto...' && manzana !== 'Seleccionar manzana...' && numero) {
            // Obtener códigos cortos (primeras 2-3 letras)
            const proyectoClave = proyecto.substring(0, 3).toUpperCase();
            const clave = `${proyectoClave}-${manzana}-${numero}`;
            $('#clave').val(clave);
        }
    }

    $('#proyectos_id, #divisiones_id, #manzanas_id, #numero').on('change input', generarClave);
        ...
        $.get('<?= base_url('admin/lotes/obtener-manzanas-por-proyecto') ?>/' + proyectoId)
            .done(function(response) {
                if (response.success) {
                    ...
                    console.error('Error en respuesta manzanas:', response.message);
                    toastr.error('Error al cargar manzanas: ' + response.message);
                }
            })
            .fail(function(xhr, status, error) {
                console.error('Error en petición AJAX manzanas:', status, error);
                console.error('Respuesta del servidor:', xhr.responseText);
        ...
        $.get('<?= base_url('admin/lotes/obtener-divisiones-por-proyecto') ?>/' + proyectoId)
            .done(function(response) {
                if (response.success) {
                    ...
                    console.error('Error en respuesta divisiones:', response.message);
                    toastr.error('Error al cargar divisiones: ' + response.message);
                }
            })
            .fail(function(xhr, status, error) {
                console.error('Error en petición AJAX divisiones:', status, error);
                console.error('Respuesta del servidor:', xhr.responseText);
    ...
    $('#form-lote').submit(function(e) {
        ...
        // Habilitar temporalmente los campos disabled para que se envíen
        $('#proyectos_id, #divisiones_id, #manzanas_id').prop('disabled', false);
        
        const url = '<?= base_url('admin/lotes/update/' . (isset($lote) ? $lote->id : '')) ?>';
        ...
        $.ajax({
            ...
            complete: function() {
                $('button[type="submit"]').prop('disabled', false).html('<i class="fas fa-save"></i> <?= isset($lote) ? 'Actualizar Lote' : 'Crear Lote' ?>');
                
                // Re-deshabilitar los campos que deben permanecer disabled
                if ($('#proyectos_id option').length <= 1) $('#proyectos_id').prop('disabled', true);
                if ($('#divisiones_id option').length <= 1) $('#divisiones_id').prop('disabled', true);
                if ($('#manzanas_id option').length <= 1) $('#manzanas_id').prop('disabled', true);
            }
        });
    });

    // Cálculo inicial si estamos editando
    <?php if (isset($lote)): ?>
    calcularPrecioTotal();
    <?php endif; ?>
});
